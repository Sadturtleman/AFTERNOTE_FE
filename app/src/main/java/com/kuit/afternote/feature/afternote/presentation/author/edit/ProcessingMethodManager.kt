 ...
 * Extracted from [com.kuit.afternote.feature.afternote.presentation.author.edit.AfternoteEditState] to keep function count under the detekt threshold.
 */
@Stable
class ProcessingMethodManager {
    var processingMethods by mutableStateOf<List<com.kuit.afternote.feature.afternote.presentation.author.edit.model.ProcessingMethodItem>>(
        emptyList(),
    )
        private set
    var galleryProcessingMethods by mutableStateOf<List<com.kuit.afternote.feature.afternote.presentation.author.edit.model.ProcessingMethodItem>>(
        emptyList(),
    )
        private set

    fun replaceProcessingMethods(list: List<com.kuit.afternote.feature.afternote.presentation.author.edit.model.ProcessingMethodItem>) {
        processingMethods = list
    }

    fun replaceGalleryProcessingMethods(list: List<com.kuit.afternote.feature.afternote.presentation.author.edit.model.ProcessingMethodItem>) {
