package com.kuit.afternote.feature.afternote.presentation.author.edit
...
import com.kuit.afternote.feature.afternote.presentation.shared.util.AfternoteServiceCatalog
import com.kuit.afternote.feature.afternote.presentation.author.edit.ProcessingMethodManager
...
class MemorialPlaylistStateHolder {
    val songs: SnapshotStateList<com.kuit.afternote.feature.afternote.presentation.author.edit.model.Song> = mutableStateListOf()

    var onSongCountChanged: (() -> Unit)? = null

    fun initializeSongs(initialSongs: List<com.kuit.afternote.feature.afternote.presentation.author.edit.model.Song>) {
        if (songs.isEmpty()) {
            songs.addAll(initialSongs)
        }
    }

    fun addSong(song: com.kuit.afternote.feature.afternote.presentation.author.edit.model.Song) {
        songs.add(song)
...
class AfternoteEditState(
    ...
    initialAfternoteEditReceivers: List<com.kuit.afternote.feature.afternote.presentation.author.edit.model.AfternoteEditReceiver>,
    ...
    var selectedProcessingMethod by mutableStateOf(
        _root_ide_package_.com.kuit.afternote.feature.afternote.presentation.author.edit.model.AccountProcessingMethod.MEMORIAL_ACCOUNT,
    )
        private set
    var selectedInformationProcessingMethod by mutableStateOf(
        _root_ide_package_.com.kuit.afternote.feature.afternote.presentation.author.edit.model.InformationProcessingMethod.TRANSFER_TO_AFTERNOTE_EDIT_RECEIVER,
    )
        private set
    ...
    val processingMethods: List<com.kuit.afternote.feature.afternote.presentation.author.edit.model.ProcessingMethodItem>
        get() = processingMethodManager.processingMethods
    val galleryProcessingMethods: List<com.kuit.afternote.feature.afternote.presentation.author.edit.model.ProcessingMethodItem>
    ...
    var categoryDropdownState by mutableStateOf(
        _root_ide_package_.com.kuit.afternote.feature.afternote.presentation.author.edit.dropdown
    ...
    val galleryAfternoteEditReceiverCallbacks: com.kuit.afternote.feature.afternote.presentation.author.edit.model.AfternoteEditReceiverCallbacks by lazy {
        _root_ide_package_.com.kuit.afternote.feature.afternote.presentation.author.edit.model.AfternoteEditReceiverCallbacks(
    ...
    val galleryProcessingCallbacks: com.kuit.afternote.feature.afternote.presentation.author.edit.model.ProcessingMethodCallbacks by lazy {
        _root_ide_package_.com.kuit.afternote.feature.afternote.presentation.author.edit.model.ProcessingMethodCallbacks(
    ...
    val socialProcessingCallbacks: com.kuit.afternote.feature.afternote.presentation.author.edit.model.ProcessingMethodCallbacks by lazy {
        _root_ide_package_.com.kuit.afternote.feature.afternote.presentation.author.edit.model.ProcessingMethodCallbacks(
    ...
    fun onProcessingMethodSelected(method: com.kuit.afternote.feature.afternote.presentation.author.edit.model.AccountProcessingMethod) {
        selectedProcessingMethod = method
    }

    fun onInformationProcessingMethodSelected(
        method: com.kuit.afternote.feature.afternote.presentation.author.edit.model.InformationProcessingMethod,
    ) {
    ...
    fun loadFromExisting(params: LoadFromExistingParams) {
        ...
        if (params.processing.accountMethodName.isNotEmpty()) {
            selectedProcessingMethod =
                runCatching {
                    _root_ide_package_.com.kuit.afternote.feature.afternote.presentation.author.edit.model.AccountProcessingMethod.valueOf(
        ...
        if (params.processing.informationMethodName.isNotEmpty()) {
            ...
            selectedInformationProcessingMethod =
                runCatching {
                    _root_ide_package_.com.kuit.afternote.feature.afternote.presentation.author.edit.model.InformationProcessingMethod.valueOf(
                        infoMethodName,
                    )
                }.getOrDefault(
                    _root_ide_package_.com.kuit.afternote.feature.afternote.presentation.author.edit.model.InformationProcessingMethod.TRANSFER_TO_AFTERNOTE_EDIT_RECEIVER,
