package com.kuit.afternote.feature.afternote.presentation.author.edit.ui
...
import com.kuit.afternote.feature.afternote.presentation.author.edit.mapper.AfternoteItemMapper
import com.kuit.afternote.feature.afternote.presentation.author.edit.model.AfternoteEditState
import com.kuit.afternote.feature.afternote.presentation.author.edit.model.DialogType
import com.kuit.afternote.feature.afternote.presentation.author.edit.model.LoadFromExistingAccountParams
import com.kuit.afternote.feature.afternote.presentation.author.edit.model.LoadFromExistingParams
import com.kuit.afternote.feature.afternote.presentation.author.edit.model.LoadFromExistingProcessingParams
...
import com.kuit.afternote.feature.afternote.presentation.author.edit.model.rememberAfternoteEditState
            ...
            state.activeDialog?.let { dialogType ->
                when (dialogType) {
                    DialogType.ADD_AFTERNOTE_EDIT_RECEIVER -> {
                        com.kuit.afternote.feature.afternote.presentation.author.edit.ui.editreceiver.AddAfternoteEditReceiverDialog(
                                params =
                                    com.kuit.afternote.feature.afternote.presentation.author.edit.ui.editreceiver.AddAfternoteEditReceiverDialogParams(
                                            ...
                                            callbacks =
                                                com.kuit.afternote.feature.afternote.presentation.author.edit.ui.editreceiver.AddAfternoteEditReceiverDialogCallbacks(
                    ...
                    DialogType.CUSTOM_SERVICE -> {
                        com.kuit.afternote.feature.afternote.presentation.author.edit.ui.processingmethod.CustomServiceDialog(
                            params =
                                com.kuit.afternote.feature.afternote.presentation.author.edit.ui.processingmethod.CustomServiceDialogParams(
                                        serviceNameState = state.customServiceNameState,
                                        callbacks =
                                            com.kuit.afternote.feature.afternote.presentation.author.edit.ui.processingmethod.CustomServiceDialogCallbacks(
                                                    onDismiss = state::dismissDialog,
...
private fun EditContent(
    ...
    Column(
        ...
        Column(
            ...
            com.kuit.afternote.feature.afternote.presentation.author.edit.ui.dropdown.SelectionDropdown(
                labelParams =
                    com.kuit.afternote.feature.afternote.presentation.author.edit.ui.dropdown.SelectionDropdownLabelParams(
                        label = "종류",
                    ),
                ...
                menuStyle =
                    com.kuit.afternote.feature.afternote.presentation.author.edit.ui.dropdown.DropdownMenuStyle(
...
private fun CategoryContent(
    ...
    when (state.selectedCategory) {
        CATEGORY_MEMORIAL_GUIDELINE -> {
            ...
            com.kuit.afternote.feature.afternote.presentation.author.edit.ui.content.MemorialGuidelineEditContent(
                bottomPadding = bottomPadding,
                params =
                    com.kuit.afternote.feature.afternote.presentation.author.edit.ui.content.MemorialGuidelineEditContentParams(
        ...
        CATEGORY_GALLERY_AND_FILE -> {
            com.kuit.afternote.feature.afternote.presentation.author.edit.ui.content.GalleryAndFileEditContent(
                bottomPadding = bottomPadding,
                params =
                    com.kuit.afternote.feature.afternote.presentation.author.edit.ui.content.GalleryAndFileEditContentParams(
            ...
            com.kuit.afternote.feature.afternote.presentation.author.edit.ui.content.SocialNetworkEditContent(
                bottomPadding = bottomPadding,
                params =
                    com.kuit.afternote.feature.afternote.presentation.author.edit.ui.content.SocialNetworkEditContentParams(
                        messageState = state.messageState,
                        accountSection =
