...
class ReceiverAuthRepositoryImpl
    ...
    constructor(
        ...
        override suspend fun getDeliveryVerificationStatus(authCode: String): Result<DeliveryVerificationResponseDto> =
            runCatching {
        ...
        override suspend fun getTimeLetterDetail(
            ...
            runCatching {
                api
                    .getTimeLetterDetail(authCode = authCode, timeLetterReceiverId = timeLetterReceiverId)
                    .requireData()
            }
