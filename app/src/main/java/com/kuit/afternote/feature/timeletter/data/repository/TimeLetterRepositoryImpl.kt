...
class TimeLetterRepositoryImpl
    ...
    constructor(
        ...
        override suspend fun getTimeLetter(timeLetterId: Long): Result<TimeLetter> =
            runCatching {
        ...
        override suspend fun deleteTimeLetters(timeLetterIds: List<Long>): Result<Unit> =
            runCatching {
        ...
        override suspend fun getTemporaryTimeLetters(): Result<TimeLetterList> =
            runCatching {
        ...
        override suspend fun deleteAllTemporary(): Result<Unit> =
            runCatching {
