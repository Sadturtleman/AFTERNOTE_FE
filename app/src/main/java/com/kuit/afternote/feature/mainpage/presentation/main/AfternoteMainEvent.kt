...
sealed interface AfternoteMainEvent {
     ...
     * 탭 선택 이벤트
     */
    data class SelectTab(val tab: AfternoteTab) : AfternoteMainEvent

    /**
     * 하단 네비게이션 아이템 선택 이벤트
     */
    data class SelectBottomNav(val navItem: BottomNavItem) : AfternoteMainEvent

    /**
     * 아이템 클릭 이벤트
     */
    data class ClickItem(val itemId: String) : AfternoteMainEvent
