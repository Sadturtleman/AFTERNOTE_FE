...
class UserRepositoryImpl @Inject constructor(
    ...
    override suspend fun getMyProfile(userId: Long): Result<UserProfile> = runCatching {
    ...
    override suspend fun getMyPushSettings(userId: Long): Result<PushSettings> = runCatching {
    ...
    override suspend fun updateMyPushSettings(
        ...
        mindRecord: Boolean?,
        afterNote: Boolean?
    ): Result<PushSettings> = runCatching {
