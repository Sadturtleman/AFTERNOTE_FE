package com.kuit.afternote.feature.afternote.presentation.shared.dummy.afternote
...
object AfternoteEditDummies {
     ...
     */
    fun defaultRecordProcessingMethods(): List<com.kuit.afternote.feature.afternote.presentation.author.edit.model.ProcessingMethodItem> =
        listOf(
     ...
     */
    fun defaultGalleryProcessingMethods(): List<com.kuit.afternote.feature.afternote.presentation.author.edit.model.ProcessingMethodItem> =
        listOf(
            _root_ide_package_.com.kuit.afternote.feature.afternote.presentation.author.edit.model.ProcessingMethodItem(
                "1",
                "'엽사' 폴더 박선호에게 전송",
     ...
     */
    fun defaultAfternoteEditReceivers(): List<com.kuit.afternote.feature.afternote.presentation.author.edit.model.AfternoteEditReceiver> =
        listOf(
     ...
     */
    fun defaultAddSongSearchResults(): List<com.kuit.afternote.feature.afternote.presentation.shared.uimodel.PlaylistSongDisplay> =
        listOf(
            PlaylistSongDisplay(
                id = "1",
                title = "보고싶다",
     ...
     */
    fun defaultSongs(): List<com.kuit.afternote.feature.afternote.presentation.author.edit.model.Song> =
        listOf(
            _root_ide_package_.com.kuit.afternote.feature.afternote.presentation.author.edit.model.Song(
                id = "1",
                title = "노래 제목",
                artist = "가수 이름",
            ),
