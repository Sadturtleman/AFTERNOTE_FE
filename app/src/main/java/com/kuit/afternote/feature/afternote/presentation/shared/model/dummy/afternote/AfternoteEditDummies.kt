package com.kuit.afternote.feature.afternote.presentation.shared.model.dummy.afternote
...
object AfternoteEditDummies {
     ...
     */
    fun defaultAddSongSearchResults(): List<com.kuit.afternote.feature.afternote.presentation.shared.model.uimodel.PlaylistSongDisplay> =
        listOf(
            PlaylistSongDisplay(
                id = "1",
                title = "보고싶다",
    ...
    fun defaultSongs(): List<com.kuit.afternote.feature.afternote.presentation.author.edit.model.Song> =
        listOf(
            com.kuit.afternote.feature.afternote.presentation.author.edit.model.Song(
                id = "1",
                title = "노래 제목",
                artist = "가수 이름",
            ),
