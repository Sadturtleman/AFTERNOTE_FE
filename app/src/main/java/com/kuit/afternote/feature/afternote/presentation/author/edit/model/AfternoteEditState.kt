...
class AfternoteEditState(
    ...
    var selectedProcessingMethod by mutableStateOf(
        com.kuit.afternote.feature.afternote.presentation.author.edit.model.AccountProcessingMethod.MEMORIAL_ACCOUNT,
    )
        private set
    var selectedInformationProcessingMethod by mutableStateOf(
        com.kuit.afternote.feature.afternote.presentation.author.edit.model.InformationProcessingMethod.TRANSFER_TO_AFTERNOTE_EDIT_RECEIVER,
    )
        private set
    ...
    var categoryDropdownState by mutableStateOf(
        com.kuit.afternote.feature.afternote.presentation.author.edit.ui.dropdown.SelectionDropdownState(),
    )
        private set
    ...
    val galleryAfternoteEditReceiverCallbacks: com.kuit.afternote.feature.afternote.presentation.author.edit.model.AfternoteEditReceiverCallbacks by lazy {
        com.kuit.afternote.feature.afternote.presentation.author.edit.model.AfternoteEditReceiverCallbacks(
    ...
    val galleryProcessingCallbacks: com.kuit.afternote.feature.afternote.presentation.author.edit.model.ProcessingMethodCallbacks by lazy {
        com.kuit.afternote.feature.afternote.presentation.author.edit.model.ProcessingMethodCallbacks(
    ...
    fun loadFromExisting(params: LoadFromExistingParams) {
        ...
        if (params.processing.accountMethodName.isNotEmpty()) {
            selectedProcessingMethod =
                runCatching {
                    com.kuit.afternote.feature.afternote.presentation.author.edit.model.AccountProcessingMethod.valueOf(
        ...
        if (params.processing.informationMethodName.isNotEmpty()) {
            ...
            selectedInformationProcessingMethod =
                runCatching {
                    com.kuit.afternote.feature.afternote.presentation.author.edit.model.InformationProcessingMethod.valueOf(
                        infoMethodName,
                    )
                }.getOrDefault(
                    com.kuit.afternote.feature.afternote.presentation.author.edit.model.InformationProcessingMethod.TRANSFER_TO_AFTERNOTE_EDIT_RECEIVER,
