...
interface AfternoteEditDataProvider {
    fun getSongs(): List<com.kuit.afternote.feature.afternote.presentation.edit.model.Song>

    fun getAfternoteEditReceivers(): List<com.kuit.afternote.feature.afternote.presentation.edit.model.AfternoteEditReceiver>
