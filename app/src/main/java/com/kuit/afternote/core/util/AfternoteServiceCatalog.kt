 ...
 * Used for edit-screen dropdowns and for inferring [com.kuit.afternote.domain.model.AfternoteServiceType] from service name
...
object AfternoteServiceCatalog {
    ...
    /**
     * Infers [com.kuit.afternote.domain.model.AfternoteServiceType] from a service display name.
