...
class PostDeliveryConditionPreferences
    ...
    constructor(
        ...
        suspend fun getDeliveryMethod(): String? = context.postDeliveryDataStore.data.first()[deliveryMethodKey]

        suspend fun getTriggerCondition(): String? = context.postDeliveryDataStore.data.first()[triggerConditionKey]

        suspend fun getTriggerDateIso(): String? = context.postDeliveryDataStore.data.first()[triggerDateIsoKey]
