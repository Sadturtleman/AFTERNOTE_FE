...
class AuthRepositoryImplTest {
    ...
    @Test
    fun login_when404NotFound_returnsFailureWithHttpException() = runTest {
    ...
    @Test
    fun login_when401Unauthorized_returnsFailureWithHttpException() = runTest {
    ...
    @Test
    fun login_when400BadRequest_returnsFailureWithHttpException() = runTest {
    ...
    @Test
    fun login_when500ServerError_returnsFailureWithHttpException() = runTest {
    ...
    @Test
    fun signUp_when409Conflict_returnsFailureWithHttpException() = runTest {
    ...
    @Test
    fun sendEmailCode_when429TooManyRequests_returnsFailureWithHttpException() = runTest {
    ...
    @Test
    fun verifyEmail_when400InvalidCode_returnsFailureWithHttpException() = runTest {
    ...
    @Test
    fun reissue_when401ExpiredToken_returnsFailureWithHttpException() = runTest {
    ...
    @Test
    fun passwordChange_when401Unauthorized_returnsFailureWithHttpException() = runTest {
    ...
    @Test
    fun logout_when401InvalidToken_returnsFailureWithHttpException() = runTest {
    ...
    @Test
    fun signUp_when400BadRequest_returnsFailureWithHttpException() = runTest {
    ...
    @Test
    fun signUp_when500ServerError_returnsFailureWithHttpException() = runTest {
        val errorBody = """{"status":500,"code":500,"message":"Internal server error"}"""
            .toResponseBody("application/json".toMediaType())
        coEvery { api.signUp(any()) } throws HttpException(
    ...
    @Test
    fun sendEmailCode_when400BadRequest_returnsFailureWithHttpException() = runTest {
        val errorBody = """{"status":400,"code":400,"message":"Invalid email format"}"""
            .toResponseBody("application/json".toMediaType())
        coEvery { api.sendEmailCode(any()) } throws HttpException(
    ...
    @Test
    fun sendEmailCode_when500ServerError_returnsFailureWithHttpException() = runTest {
    ...
    @Test
    fun verifyEmail_when401CodeExpired_returnsFailureWithHttpException() = runTest {
    ...
    @Test
    fun verifyEmail_when404EmailNotFound_returnsFailureWithHttpException() = runTest {
    ...
    @Test
    fun verifyEmail_when500ServerError_returnsFailureWithHttpException() = runTest {
        val errorBody = """{"status":500,"code":500,"message":"Internal server error"}"""
            .toResponseBody("application/json".toMediaType())
        coEvery { api.verifyEmail(any()) } throws HttpException(
    ...
    @Test
    fun reissue_when400InvalidToken_returnsFailureWithHttpException() = runTest {
    ...
    @Test
    fun reissue_when500ServerError_returnsFailureWithHttpException() = runTest {
        val errorBody = """{"status":500,"code":500,"message":"Internal server error"}"""
            .toResponseBody("application/json".toMediaType())
        coEvery { api.reissue(any()) } throws HttpException(
    ...
    @Test
    fun logout_when400InvalidToken_returnsFailureWithHttpException() = runTest {
        val errorBody = """{"status":400,"code":400,"message":"Invalid token format"}"""
            .toResponseBody("application/json".toMediaType())
        coEvery { api.logout(any()) } throws HttpException(
            Response.error<Unit>(400, errorBody)
    ...
    @Test
    fun logout_when500ServerError_returnsFailureWithHttpException() = runTest {
        val errorBody = """{"status":500,"code":500,"message":"Internal server error"}"""
            .toResponseBody("application/json".toMediaType())
        coEvery { api.logout(any()) } throws HttpException(
            Response.error<Unit>(500, errorBody)
    ...
    @Test
    fun passwordChange_when400BadRequest_returnsFailureWithHttpException() = runTest {
        val errorBody = """{"status":400,"code":400,"message":"Invalid password format"}"""
            .toResponseBody("application/json".toMediaType())
        coEvery { api.passwordChange(any()) } throws HttpException(
            Response.error<Unit>(400, errorBody)
    ...
    @Test
    fun passwordChange_when404UserNotFound_returnsFailureWithHttpException() = runTest {
        val errorBody = """{"status":404,"code":404,"message":"User not found"}"""
            .toResponseBody("application/json".toMediaType())
        coEvery { api.passwordChange(any()) } throws HttpException(
    ...
    @Test
    fun passwordChange_when500ServerError_returnsFailureWithHttpException() = runTest {
        val errorBody = """{"status":500,"code":500,"message":"Internal server error"}"""
            .toResponseBody("application/json".toMediaType())
        coEvery { api.passwordChange(any()) } throws HttpException(
            Response.error<Unit>(500, errorBody)
    ...
    @Test
    fun login_whenNetworkError_returnsFailure() = runTest {
    ...
    @Test
    fun signUp_whenNetworkError_returnsFailure() = runTest {
    ...
    @Test
    fun sendEmailCode_whenNetworkError_returnsFailure() = runTest {
    ...
    @Test
    fun verifyEmail_whenNetworkError_returnsFailure() = runTest {
    ...
    @Test
    fun reissue_whenNetworkError_returnsFailure() = runTest {
    ...
    @Test
    fun logout_whenNetworkError_returnsFailure() = runTest {
    ...
    @Test
    fun passwordChange_whenNetworkError_returnsFailure() = runTest {
