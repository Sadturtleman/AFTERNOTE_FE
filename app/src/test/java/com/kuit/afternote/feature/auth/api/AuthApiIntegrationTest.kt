...
class AuthApiIntegrationTest {
    ...
    @Test
    fun login_withWrongPassword_returnsExpectedStatusCode() =
        runBlocking {
            try {
                authApi.login(
    ...
    @Test
    fun login_withNonExistentAccount_returnsExpectedStatusCode() =
        runBlocking {
            try {
                authApi.login(
    ...
    @Test
    fun sendEmailCode_withInvalidEmailFormat_returns400() =
        runBlocking {
            try {
    ...
    @Test
    fun verifyEmail_withWrongCode_returnsExpectedStatusCode() =
        runBlocking {
            try {
                authApi.verifyEmail(
    ...
    @Test
    fun signUp_withExistingEmail_returns409() =
        runBlocking {
            try {
                authApi.signUp(
                    SignUpRequest(
    ...
    @Test
    fun signUp_withInvalidPasswordFormat_returns400() =
        runBlocking {
            try {
                authApi.signUp(
                    SignUpRequest(
    ...
    @Test
    fun login_withEmptyEmail_returns400() =
        runBlocking {
            try {
    ...
    @Test
    fun login_withEmptyPassword_returns400() =
        runBlocking {
            try {
    ...
    @Test
    fun reissue_withValidRefreshToken_returns200() =
        runBlocking {
            loginAndGetTokens()
    ...
    @Test
    fun reissue_withInvalidToken_returnsExpectedStatusCode() =
        runBlocking {
            try {
    ...
    @Test
    fun reissue_withEmptyToken_returns400() =
        runBlocking {
            try {
    ...
    @Test
    fun logout_withInvalidToken_returnsExpectedStatusCode() =
        runBlocking {
            try {
    ...
    @Test
    fun logout_withEmptyToken_returns401() =
        runBlocking {
            try {
    ...
    @Test
    fun passwordChange_withWrongCurrentPassword_returnsExpectedStatusCode() =
        runBlocking {
            loginAndGetTokens()
    ...
    @Test
    fun passwordChange_withInvalidNewPasswordFormat_returns400() =
        runBlocking {
            loginAndGetTokens()
    ...
    @Test
    fun passwordChange_withoutAuthentication_returns401() =
        runBlocking {
            try {
                // 인증 없이 비밀번호 변경 시도
    ...
    @Test
    fun sendEmailCode_withEmptyEmail_returns400() =
        runBlocking {
            try {
    ...
    @Test
    fun verifyEmail_withNonExistentEmail_returnsExpectedStatusCode() =
        runBlocking {
            try {
                authApi.verifyEmail(
    ...
    @Test
    fun verifyEmail_withEmptyCode_returns400() =
        runBlocking {
            try {
                authApi.verifyEmail(
    ...
    @Test
    fun signUp_withInvalidEmailFormat_returns400() =
        runBlocking {
            try {
                authApi.signUp(
                    SignUpRequest(
     ...
     */
    @Test
    fun documentAllActualStatusCodes() =
        runBlocking {
